  ...
  void didChangeDependencies() {
    ...
    if (!_loaded) {
      ...
      if (args != null) {
        ...
        _selectedDate = DateTime.fromMillisecondsSinceEpoch(args.date);
        _selectedTime = TimeOfDay(
          hour: args.time ~/ 3600,
          minute: (args.time % 3600) ~/ 60,
        );
        selectedCategoryIndex = categories.indexOf(args.category);
        currentTask = args;
      }
      _loaded = true;
    }
        ...
        appBar: PreferredSize(
          ...
          child: Directionality(
            ...
            child: AppBar(
              ...
              title: Text('update_event'.tr(),style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                  color: Theme.of(context).primaryColor
              ),),
              actions: [
                IconButton(
                  icon: Icon(!isEditable ? Icons.edit : Icons.save, color: Theme.of(context).primaryColor),
                  onPressed: () {
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed:isEditable? _pickDate : (){},
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: isEditable ? _pickTime : (){},
                        ...
                        child: ElevatedButton(
                            onPressed: (){
                              if (formKey.currentState!.validate()) {
                                ...
                                print("taskModel: ${taskModel.toJson()}");
                                tasksProvider.updateTask(taskModel,context);
                              }
