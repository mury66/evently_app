...
class IntroScreen extends StatelessWidget {
  ...
  Widget buildImage(String path) {
    return Container(
      ...
      child: Image.asset("assets/images/$path.png", fit: BoxFit.cover),
    );
  }
    ...
    return Scaffold(
      ...
      body: IntroductionScreen(
        showNextButton: true,
          ...
          isArabic ? "assets/images/back_arr.png" : "assets/images/nxt_arr.png",
          width: 38.r,
          height: 38.r,
        ),
        showBackButton: true,
        back: Image.asset(
          isArabic ? "assets/images/nxt_arr.png" : "assets/images/back_arr.png",
          width: 38.r,
          height: 38.r,
        ),
        next: Directionality(
          ...
          child: Image.asset(
            isArabic
                ? "assets/images/back_arr.png"
                : "assets/images/nxt_arr.png",
            width: 38.r,
            height: 38.r,
          ),
        ),
        ...
        pages: [
          PageViewModel(
            decoration: PageDecoration(imageFlex: 4, bodyFlex: 3),
            titleWidget: Align(
              alignment: SharedPreferencesHelper.getLanguage() == "ar"
          ...
          PageViewModel(
            ...
            bodyWidget: Align(
              alignment: SharedPreferencesHelper.getLanguage() == "ar"
                  ? Alignment.centerRight
                  : Alignment.centerLeft,
              child: Text("introduction_body2".tr(),
                style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                  color: Theme.of(context).colorScheme.onSecondary,
                ),),
            ),
          ...
          PageViewModel(
            ...
            bodyWidget: Align(
              alignment: SharedPreferencesHelper.getLanguage() == "ar"
                  ? Alignment.centerRight
                  : Alignment.centerLeft,
              child: Text("introduction_body3".tr(),
                style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                  color: Theme.of(context).colorScheme.onSecondary,
                ),),
            ),
